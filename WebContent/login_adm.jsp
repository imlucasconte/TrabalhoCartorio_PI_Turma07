...
<c:import url="_CODIGOS/head.jsp"/>
	<title>Fazer Adm - Cartório Papiro</title>
	<meta charset="utf-8">
				...
				<div class="modal-content">
					...
					<form action="controller.do" method="POST"class="col-12">
						...
						<div class="form-group">
						  ...
						  <div class="controls">
			        <button class="btn btn-success" type="submit" name="command" value=RealizarLoginADM>Logar</button>
			      </div>
						<div class="col-12 forgot"> 
						<a href="cadastrar.jsp">Cadastre-se</a>
						</br>
						<a href="login.jsp">Usuario comum</a>
						</div>
					</form>
							<%
